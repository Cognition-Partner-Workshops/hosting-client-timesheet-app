...
class ApiClient {
  ...
  async getDashboardDefaulters() {
    const response = await this.client.get('/api/dashboard/defaulters');
    return response.data;
  }

  async getDashboardDueDates() {
    const response = await this.client.get('/api/dashboard/due-dates');
    return response.data;
  }
